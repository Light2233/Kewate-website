...
<ApplicationModalWindow bind:showModal bg={modalBg} page={"/"}/>
        ...
        <div class="dialog_content">
            <div class="menu">
                ...
                <div class="title">
                    ...
                    <button on:click={() => {dialog.close(),open=false}} type="button">
                        ...
                        <div class="development services_row">
                            ...
                            <div class="map">
                                <div class="websites link_ul">
                                    ...
                                    <a href="/pages/landing-page" class="main_sm_16 service_link" on:click={()=>{open=false;dialog.close(),servicesOpen = false}}>Одностраничный сайт<img src="{ arrow_up }" alt=""></a>
                                    <a href="/pages/multi-page-website" class="main_sm_16 service_link" on:click={()=>{open=false;dialog.close(),servicesOpen = false}}>Многостраничный сайт <img src="{ arrow_up }" alt=""></a>
                                    <a href="/pages/online-store" class="main_sm_16 service_link" on:click={()=>{open=false;dialog.close(),servicesOpen = false}}>Интернет-магазин<img src="{ arrow_up }" alt=""></a>
                                </div>

                    ...
                    <div class="development services_row">
                        ...
                        <div class="map">
                            <div class="websites link_ul">
                                ...
                                <a href="/landing" class="main_sm_16 service_link" on:click={()=>{open=false;dialog.close(),servicesOpen = false}}>Одностраничный сайт<img src="{ arrow_up }" alt=""></a>
                                <a href="/multi-page" class="main_sm_16 service_link" on:click={()=>{open=false;dialog.close(),servicesOpen = false}}>Многостраничный сайт <img src="{ arrow_up }" alt=""></a>
                                <a href="/store" class="main_sm_16 service_link" on:click={()=>{open=false;dialog.close(),servicesOpen = false}}>Интернет-магазин<img src="{ arrow_up }" alt=""></a>
                            </div>
